...
class TexinfoLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            include('base'),
            (r'''(@)(node|section|subsection|subsubsection|part|chapter|
               centerchap|unnumbered|unnumberedsec|unnumberedsubsec|
               unnumberedsubsection|unnumberedsubsubsec|
               unnumberedsubsubsection|chapheading|majorheading|heading|
               subheading|subsubheading|appendix|appendixsec|appendixsection|
               appendixsubsec|appendixsubsection|appendixsubsubsec|
               appendixsubsubsection|[cfvkpt]index|printindex|syncodeindex)(\s)''',
